...
final class Review_Screen implements Service {
	...
	private static function strings(): array {
		return array(
			...
			'placementChangeWarn'      => __( 'This change alters the ad sizes.', 'aggressive-ads' ),
			'placementChangeBody'      => __( 'A size it adds runs no ad until the advertiser supplies one and it is reviewed.', 'aggressive-ads' ),
