		...
		$payload = array(
			...
			'brand'     => array(
				...
				'colours'      => array(
					...
					array(
						'key'   => 'accent_strong',
						'label' => __( 'Accent for links and accented text', 'aggressive-ads' ),
			...
			'i18n'      => array(
				...
				'deliveryHelp'      => __( 'Native fill cache and house-ad policy.', 'aggressive-ads' ),
				'fillTtl'           => __( 'Fill cache TTL (seconds)', 'aggressive-ads' ),
				'houseAds'          => __( 'House ads', 'aggressive-ads' ),
				'retention'         => __( 'Retention', 'aggressive-ads' ),
