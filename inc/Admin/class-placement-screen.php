...
final class Placement_Screen implements Service {
	...
	public function enqueue( string $hook_suffix ): void {
		...
		$version = Shared_Assets::enqueue_bundle( 'aggr-inventory', 'inventory' );
	...
	private function render_screen(): void {
		...
		$payload = array(
			...
			'i18n'     => array(
				...
				'maxFileSize'         => __( 'Maximum file size (KB)', 'aggressive-ads' ),
				'maxFileSizeHelp'     => __( 'The largest ad creative an advertiser may upload for this placement. 150 KB suits most display advertising; raise it only where the artwork genuinely needs it, because every kilobyte here is paid for by every visitor to the page.', 'aggressive-ads' ),
				'maxFileSizeColumn'   => __( 'Max file', 'aggressive-ads' ),
