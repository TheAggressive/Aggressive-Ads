...
final class Placement_Screen implements Service {
	...
	private function posted_fields(): array {
		return array(
			...
			'house_attachment_id' => isset( $_POST['house_attachment_id'] ) ? absint( wp_unslash( $_POST['house_attachment_id'] ) ) : 0, // phpcs:ignore WordPress.Security.NonceVerification.Missing
